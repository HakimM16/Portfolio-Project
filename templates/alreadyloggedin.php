...
<body>
    ...
    <div class="container">
        ...
        <br>
        <?php
            // redirected in 2 secs
            echo '<p>You will be redirected to the <strong>home page</strong>.</p>';
            header("refresh:1;url=http://localhost/phase2/index.php"); // redirect to index.php after 2 seconds
